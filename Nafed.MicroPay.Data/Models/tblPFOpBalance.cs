...
namespace Nafed.MicroPay.Data.Models
{
    ...
    public partial class tblPFOpBalance
    {
        ...
        public Nullable<decimal> CB_Non_Taxable { get; set; }
        public Nullable<decimal> CB_Taxable { get; set; }
        public Nullable<decimal> IA_Non_Taxable { get; set; }
        public Nullable<decimal> IA_Taxable { get; set; }
        public Nullable<decimal> TDS_Rate { get; set; }
