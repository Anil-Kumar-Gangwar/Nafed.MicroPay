    ...
    public class EmployeeService : BaseService, IEmployeeService
    {
        ...
        public int InsertEmployeeDetails(Model.Employee employeeDetails)
        {
            ...
            try
            {
                ...
                #region 2023 Nov 23 
                empSalRow.E_SP = 0;
                empSalRow.LastIncrement = 0;
                empSalRow.SPCashALW = 0;
                empSalRow.SPTelexALW = 0;
                empSalRow.SPStenographyALW = 0;
                empSalRow.SPAccWorkALW = 0;
                empSalRow.SPODupMachineALW = 0;
                empSalRow.SPFaxMachineALW = 0;
                empSalRow.SPAsDriverALW = 0;
                empSalRow.E_FDA = 0;
                empSalRow.E_01 = 0;
                empSalRow.E_02 = 0;
                empSalRow.E_03 = 0;
                ...
                empSalRow.E_08 = 0;
                empSalRow.E_09 = 0;
                empSalRow.SANightWatch = 0;
                empSalRow.SADCAllowance = 0;
                empSalRow.SAAssamComp = 0;
                empSalRow.SAFairEPart = 0;
                empSalRow.SAToSplPost = 0;
                empSalRow.E_10 = 0;
                empSalRow.E_11 = 0;
                empSalRow.E_12 = 0;
                empSalRow.E_13 = 0;
                ...
                empSalRow.D_30 = 0;
                empSalRow.HRA = false;
                empSalRow.UnionFee = false;
                empSalRow.ProfTax = false;
                empSalRow.NoofChildren = 0;
                empSalRow.SportClub = false;
                empSalRow.IsRateVPF = false;
                empSalRow.VPFValueRA = 0;
                empSalRow.CCA = false;
                empSalRow.WASHING = false;
                empSalRow.None = false;
                empSalRow.DELETEDEMPLOYEE = false;
                empSalRow.IsFlatDeduction = false;
                empSalRow.IsOTACode = false;
                empSalRow.IsSuspended = false;
                empSalRow.IsPensionDeducted = false;
                empSalRow.BasicSalPercentageForSuspendedEmp = 0;
                empSalRow.E_Basic_Pay = 0;
