...
{
    public class UpdateIncrementController : BaseController
    {
        private readonly IDropdownBindService ddlService;
        private readonly IIncrement incrementService;
        public UpdateIncrementController(IDropdownBindService ddlService, IIncrement incrementService)
        {
        ...
        {
            log.Info($"UpdateIncrementController/Index");
            try
            {
                ...
                var projectedInc = incrementService.GetUpdateIncrementDetails(null, "", "", null);
                TempData["UpdateIncrementDetails"] = projectedInc;
        ...
        [HttpGet]
        public ActionResult _GetUpdateIncrementGridView(ProjectedIncrementViewModel pVM)
        {
            try
            {
                ...
                if (TempData["UpdateIncrementDetails"] != null)
                {
                    dataDetails = (List<Model.ProjectedIncrement>)TempData["UpdateIncrementDetails"];
                    TempData.Keep("UpdateIncrementDetails");
                ...
                return PartialView("_UpdateIncrementGridView", projectedVM);
            }
            catch (Exception ex)
            {
                log.Error("Message-" + ex.Message + " StackTrace-" + ex.StackTrace + " DatetimeStamp-" + DateTime.Now);
        ...
        [HttpPost]
        public ActionResult PostUpdateIncrementDetails(ProjectedIncrementViewModel pVM, string Validate)
        {
            try
            {
                ProjectedIncrementViewModel projectedVM = new ProjectedIncrementViewModel();
                ...
                if (pVM.projectedIncrement != null)
                {
                    if (pVM.projectedIncrement.Count() > 0)
                    {
                        ...
                        {
                            return ExportUpdateIncrement(pVM);
                        }
                        ...
                        else if (Validate.ToLower().Trim() == "update grid" && changedrow.Count > 0)
                        {
                            ...
                            incrementService.UpdateEmployeeSalaryDetails(UpdateGrid);
                            pVM.incrementMonthId = pVM.incrementMonthId == 0 ? null : pVM.incrementMonthId;
                            var projectedInc = incrementService.GetUpdateIncrementDetails(pVM.BranchID, pVM.EmployeeCode, pVM.EmployeeName, pVM.incrementMonthId);
                            ...
                            TempData["UpdateIncrementDetails"] = projectedIncrementAll;
                            return PartialView("_UpdateIncrementGridView", projectedVM);
                        }
                        else
                        {
                            return PartialView("_UpdateIncrementGridView", pVM);
                        }
                    }
                }
                else
        ...
        public bool fnValidateNewBasicAmount(decimal? NewCurrentBasic, int? EmployeeId, string BranchCode, int BranchID, bool? ProceedFurther, out string strNewBasicAmount)
        {
            strNewBasicAmount = "";
            bool flag = false;
            var validateDetails = incrementService.GetUpdateValidateNewBasicAmountDetails(EmployeeId.Value, null);
        ...
        public ActionResult UpdateBasicDetails(ProjectedIncrementViewModel pVM)
        {
            try
            {
               ...
               // int i = 0;
                ...
                var strfnValidate = fnValidateMonth(pVM.incrementMonthId);
                if (strfnValidate != "0")
                {

                    ViewBag.Message = "Salary Increment is already done for the month of " + (pVM.incrementMonthId == 1 ? "January" : "July") + " on " + strfnValidate + "";
                    var projectedInc = incrementService.GetUpdateIncrementDetails(pVM.BranchID, pVM.EmployeeCode, pVM.EmployeeName, pVM.incrementMonthId);
                ...
                else
                {
                    ...
                    {
                        var updateBasicEmpDetails = incrementService.GetUpdateValidateNewBasicAmountDetails(null, pVM.incrementMonthId).ToList();
                        ...
                        foreach (DataRow row in dataTable.Rows)
                        {
                            ...
                            if (SlabMatch)
                            {
                                ...
                                updateBasicModel.OldBasic = dblBasic /*Convert.ToDecimal(row["LastBasic"])*/;
                                updateBasicModel.LastIncrement = dblIncrement /*Convert.ToDecimal(row["LastIncrement"])*/;
                        ...
                        //    decimal?[] e = new decimal?[40];
                        //    dblIncrement = 0;
                        //    string strEmpCode = updateBasicEmpDetails[i].EmployeeCode;
                        //    decimal? dblBasic = updateBasicEmpDetails[i].e_Basic == null ? 0 : updateBasicEmpDetails[i].e_Basic;
                        //    string level = updateBasicEmpDetails[i].Level;
                        ...
                        //        for (int x = 1; x <= limit; x++)
                        //        {
                        //            //b[x] = BasicIncrementValue(x, updateBasicEmpDetails[i], "B");
                        //            //e[x] = BasicIncrementValue(x, updateBasicEmpDetails[i], "E");
                        //        }
                        //    }
                        //    else
                        //    {
                        ...
                        //}
                        //Add Update Function 
                        var insertUpdate = incrementService.UpdateEmployeeSalaryDetails(UpdateBasicAmount);
                        Model.LastIncrementMonth lastincMonth = new Model.LastIncrementMonth();
                        lastincMonth.IncrementMonth = pVM.incrementMonthId;

                        int currentMonth = DateTime.Now.Month;                       
                        if (currentMonth == 12)
                            lastincMonth.IncrementYear = DateTime.Now.Year + 1;
                        else
                        lastincMonth.IncrementYear = DateTime.Now.Year;
                        var updateLastIncrement = incrementService.InsertUpdateLastIncrementDetails(lastincMonth, userDetail.UserID);
                        var projectedInc = incrementService.GetUpdateIncrementDetails(pVM.BranchID, pVM.EmployeeCode, pVM.EmployeeName, pVM.incrementMonthId);
                        projectedInc.ForEach(x => { x.CurrentBasic = Convert.ToInt32(x.CurrentBasic); x.OldBasic = Convert.ToInt32(x.OldBasic); x.LastIncrement = Convert.ToInt32(x.LastIncrement); });
                        TempData["UpdateIncrementDetails"] = projectedInc;
                        projectedVM.projectedIncrement = projectedInc;
        ...
        public string fnValidateMonth(int? incrementMonthId)
        {
            var lastIncrementDate = incrementService.GetLastIncrementMonthDetails(incrementMonthId);
            return lastIncrementDate;
        }

        //public decimal? BasicIncrementValue(int x, Model.ValidateNewBasicAmount updateBasicEmpDetails, string type)
        //{
        //    decimal? value;
        //    if (type == "B")
        //    {
        ...
        //        {
        //            case 1:
        //                value = updateBasicEmpDetails.B1;
        //                break;
        //            case 2:
        //                value = updateBasicEmpDetails.B2;
        //                break;
        //            case 3:
        //                value = updateBasicEmpDetails.B3;
        //                break;
        //            case 4:
        //                value = updateBasicEmpDetails.B4;
        //                break;
        //            case 5:
        //                value = updateBasicEmpDetails.B5;
        //                break;
        //            case 6:
        //                value = updateBasicEmpDetails.B6;
        //                break;
        //            case 7:
        //                value = updateBasicEmpDetails.B7;
        //                break;
        //            case 8:
        //                value = updateBasicEmpDetails.B8;
        //                break;
        //            case 9:
        //                value = updateBasicEmpDetails.B9;
        //                break;
        //            case 10:
        //                value = updateBasicEmpDetails.B10;
        //                break;
        //            case 11:
        //                value = updateBasicEmpDetails.B11;
        //                break;
        //            case 12:
        //                value = updateBasicEmpDetails.B12;
        //                break;
        //            case 13:
        //                value = updateBasicEmpDetails.B13;
        //                break;
        //            case 14:
        //                value = updateBasicEmpDetails.B14;
        //                break;
        //            case 15:
        //                value = updateBasicEmpDetails.B15;
        //                break;
        //            case 16:
        //                value = updateBasicEmpDetails.B16;
        //                break;
        //            case 17:
        //                value = updateBasicEmpDetails.B17;
        //                break;
        //            case 18:
        //                value = updateBasicEmpDetails.B18;
        //                break;
        //            case 19:
        //                value = updateBasicEmpDetails.B19;
        //                break;
        //            case 20:
        //                value = updateBasicEmpDetails.B20;
        //                break;
        //            case 21:
        //                value = updateBasicEmpDetails.B21;
        //                break;
        //            case 22:
        //                value = updateBasicEmpDetails.B22;
        //                break;
        //            case 23:
        //                value = updateBasicEmpDetails.B23;
        //                break;
        //            case 24:
        //                value = updateBasicEmpDetails.B24;
        //                break;
        //            case 25:
        //                value = updateBasicEmpDetails.B25;
        //                break;
        //            case 26:
        //                value = updateBasicEmpDetails.B26;
        //                break;
        //            case 27:
        //                value = updateBasicEmpDetails.B27;
        //                break;
        //            case 28:
        //                value = updateBasicEmpDetails.B28;
        //                break;
        //            case 29:
        //                value = updateBasicEmpDetails.B29;
        //                break;
        //            case 30:
        //                value = updateBasicEmpDetails.B30;
        //                break;
        //            case 31:
        //                value = updateBasicEmpDetails.B31;
        //                break;
        //            case 32:
        //                value = updateBasicEmpDetails.B32;
        //                break;
        //            case 33:
        //                value = updateBasicEmpDetails.B33;
        //                break;
        //            case 34:
        //                value = updateBasicEmpDetails.B34;
        //                break;
        //            case 35:
        //                value = updateBasicEmpDetails.B35;
        //                break;
        //            case 36:
        //                value = updateBasicEmpDetails.B36;
        //                break;
        //            case 37:
        //                value = updateBasicEmpDetails.B37;
        //                break;
        //            case 38:
        //                value = updateBasicEmpDetails.B38;
        //                break;
        //            case 39:
        //                value = updateBasicEmpDetails.B39;
        //                break;
        //            case 40:
        //                value = updateBasicEmpDetails.B40;
        //                break;
        //            default:
        //                value = 0;
        //                break;
        ...
        public ActionResult ExportUpdateIncrement(ProjectedIncrementViewModel pVM)
        {
            log.Info($"UpdateIncrementController/ExportUpdateIncrement");
            try
            {
                pVM.EmployeeCode = pVM.EmployeeCode != null ? pVM.EmployeeCode.Trim() : pVM.EmployeeCode;
                pVM.EmployeeName = pVM.EmployeeName != null ? pVM.EmployeeName.Trim() : pVM.EmployeeName;
                ...
                fileName = ExtensionMethods.SetUniqueFileName("UpdateIncr-", FileExtension.xlsx);
                var res = incrementService.ExportIncrement(pVM.BranchID, pVM.incrementMonthId, pVM.EmployeeName, pVM.EmployeeCode, fileName, fullPath, "2");
                return Json(new { fileName = fileName, fullPath = fullPath + fileName, htmlData = ConvertViewToString("_UpdateIncrementGridView", pVM), message = "success" });
            }
            catch (Exception ex)
            {
                log.Error("Message-" + ex.Message + " StackTrace-" + ex.StackTrace + " DatetimeStamp-" + DateTime.Now);
